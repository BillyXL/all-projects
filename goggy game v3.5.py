...
print(f"{Fore.RED}Exercise: {exercise}")
print(f"{Fore.BLUE}Attention Span: {attentionspan}")
print(f"{Fore.GREEN}Charisma: {charisma}")
print(f"{Fore.YELLOW}Fear: {fear}")
print(f"{Fore.WHITE}Sleep: {sleep}")
print(f"{Fore.RED}sleepiness: {sleepiness}")
def adjustvalue():
    global health
    global charisma
    while health > 100:
...
print(f"{Fore.BLUE}Hello investor! What should I call you?")
UserName = input()
...
while alive == 1:
    ...
    print("------------------")
    print(f"{Fore.RED}A - Watch the news")
    print("------------------")
    print(f"{Fore.BLUE}B - Go to the investing page")
    print("----------------------------")
    print(f"{Fore.GREEN}C - Go to health improvement")
    print("----------------------------")
    print(f"{Fore.YELLOW}D - Go to bank")
    print("--------------")
    print(f"{Fore.WHITE}E - Check your balance")
    print(f"{Fore.BLACK}----------------------")
    ...
    if place == "a":
        print("-------------------")
        print(f"{Fore.BLUE}You chose option A.")
        print("-------------------")
        hour = hour + 23
        minutes, hour, day, week, month, year = adjusttime(minutes, hour, day, week, month, year)
        chosen = 0
        ...
        i = 1
        print("-------------------------------------------")
        answerhold = input(f"do you want to\n--------------\nA-buy stocks\n------------\nB-sell stocks")
        if answerhold == "a":
            while i <= 30:
...
#health section        
        ...
        print("Choose an option:")
        print(f"{Fore.RED}A - have a check up")
        print(f"{Fore.BLUE}B - exercise (1 hours)("+str(exercisecounter)+"/"+str(exercise)+")")
        print(f"{Fore.WHITE}C - sleep ("+str(sleepcounter)+"/"+str(sleep)," hours)")
        print(f"{Fore.YELLOW}D - eat ("+str(eatcounter)+"/"+str(hunger)+")")

        option = input().lower()

        if option == "a":
            print(f"{Fore.WHITE}You chose option A - have a check up (1 hour).")
            while checkupend == 1:
                print(f"{Fore.GREEN}choose an option")
                print(f"{Fore.RED}A drive to the doctors")
                print(f"{Fore.BLUE}B walk to the doctors")
               
                optioncheckup = input().lower()

                   
                if optioncheckup == "a":
                    print(f"{Fore.RED}you get into the car")
                    50
                    crashchance = sleepiness*2
                    crash = random.randint(1,100)
                    print(crash)
                    if crash <= crashchance:
                        print(f"{Fore.BLUE}you drift of slightly as you round a corner and slam into incoming traffic")
                        print(f"{Fore.RED}you die")
                        sys.exit
                ...
                time.sleep(1)
                print("you will only be able to invest",str(100-(fear//1)*10)+"% of your total balance due to your anxiety")
                time.sleep(1)
                if charisma >= 11:
